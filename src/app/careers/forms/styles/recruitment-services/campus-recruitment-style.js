// Src/app/carrier/styles/recruitment-services/campus-recruitment-style.js
...
export const formStyles = {
  ...
  checkbox:
    "mt-1 w-5 h-5 shrink-0 min-w-[20px] min-h-[20px] rounded-[6px] border border-white/[0.2] bg-[#050E21] checked:bg-[#60A5FA] checked:border-[#60A5FA] appearance-none flex items-center justify-center transition-all duration-300 cursor-pointer group-hover:border-[#60A5FA]/50 relative before:content-[''] before:w-2.5 before:h-2.5 before:bg-[#050E21] before:rounded-sm before:opacity-0 checked:before:opacity-100",
  checkboxLabel:
