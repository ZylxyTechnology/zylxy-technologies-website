...
export default function WebApplicationForm() {
  ...
  const [state, formAction, isPending] = useActionState(submitWebLeadAction, {
    success: false,
    errors: {},
    payload: {},
  });
        ...
        {!state?.success ? (
          <form action={formAction} className={s.formCard}>
            ...
            <div className={s.complianceBlock}>
              ...
              >
                ...
                <span className={s.complianceLabel}>
                  I agree to receive alternate operational communications from
                  Zylxy Technologies.
                </span>
              </div>
            ...
            <div className={s.footerRow}>
              <p className={s.privacyFooter}>
                Data containment boundaries align with absolute privacy
                safeguards.
              </p>
              <div className={s.submitBtnWrapper}>
                ...
                >
                  {isPending ? "Syncing Pipeline..." : "Transmit Request"}
          ...
          <div className={s.successCard}>
            ...
            <p className={s.successText}>
              Thank you, {state.submittedName}. Our software engineering cluster
              has indexed your web development context and will initiate
              communication channels at {state.submittedEmail} within 24 hours.
            </p>
          </div>
        )}
      </div>
