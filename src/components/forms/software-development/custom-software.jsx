...
import { customSoftwareData as d } from "@/data/forms/software-development/custom-software";
import { customSoftwareStyles as s } from "@/styles/forms/software-development/custom-software";
import {
  Building2,
  CalendarCheck,
  ChevronDown,
...
export default function CustomSoftwareForm({ isEmbedded = false }) {
  const {
    formData,
    selectedCountry,
    setSelectedCountry,
  ...
  const performSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "/api/lead/software-development/custom-software",
        {
          method: "POST",
  ...
  return (
    <section id="CustomSoftwareLeadGen" className={s.section}>
