...
import { brandDesignFormData as d } from "@/data/forms/software-development/brand-design";
import { brandDesignFormStyles as s } from "@/styles/forms/software-development/brand-design";
import {
  Building2,
  CalendarCheck,
  ChevronDown,
  ...
  const performSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "/api/lead/software-development/brand-design",
        {
          method: "POST",
              ...
              <div className={s.inputGroup}>
                ...
                <div className={s.inputWrapper}>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Describe your creative requirements, design preferences, brand values, or target audience details..."
