...
import { aiAutomationFormData as d } from "@/data/forms/ai-crm-solutions/ai-automation";
import { aiAutomationFormStyles as s } from "@/styles/forms/ai-crm-solutions/ai-automation";
import {
  Building2,
  CalendarCheck,
  ChevronDown,
...
export default function AiAutomationForm() {
  ...
  const performSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/lead/ai-crm-solutions/ai-automation", {
        method: "POST",
      ...
      if (!response.ok || !result.success) {
        setErrors(
          result.errors || {
            global: "Data sync cluster system mapping error loop.",
          },
        );
      } else {
        setIsSuccess(true);
      ...
      setErrors({ global: "Data node connection interface timeout sequence." });
    } finally {
      setIsPending(false);
    }
  };
  ...
  return (
    <section id="AiAutomationLeadGen" className={s.section}>
        ...
        {!isSuccess ? (
          ...
          >
            ...
            <div className={s.disclosureContainer}>
              <div className={s.inputGroup}>
                ...
                <div className={s.challengesContainer}>
                  {d.automationTargets.map((target) => {
              ...
              <div className={s.inputGroup}>
                ...
                <div className={s.inputWrapper}>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Describe your workflow targets, training data availability, target compliance layers, or interface architecture layouts..."
            ...
            <div className={s.footerRow}>
              <p className={s.privacyFooter}>
                ...
                safeguards. Form configuration sync maps database verification
                criteria.
              </p>
          ...
          <div className={s.successCard}>
            ...
            <p className={s.successText}>
              ...
              request. Our automated systems engineering cluster is parsing your
