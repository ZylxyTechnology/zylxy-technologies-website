export const leadGenStyles = {
  ...
  labelError:
    "block text-[11px] font-bold font-inter text-[#ff6b6b] tracking-[0.06em] uppercase mb-2 transition-colors duration-200",
  input:
  ...
  inputError: "border-[#ff6b6b] focus:border-[#ff6b6b] bg-[#ff6b6b]/5",
  select:
  ...
  errorText:
    "text-[#ff6b6b] text-xs font-inter mt-1.5 flex items-center gap-1.5 animate-[fadeIn_0.2s_ease-out]",
  footerRow:
