export const caseStudiesStyles = {
  ...
  pillLineBar: "w-[22px] h-0.5 mb-5 bg-[#2563EB] rounded-sm",
  pillText:
    "text-[13px] relative -top-2.5 font-bold font-inter text-[#60A5FA] tracking-widest uppercase",
  mainHeading:
    "font-syne font-extrabold text-3xl md:text-4xl lg:text-5xl text-white tracking-tighter leading-[1.05]",
  subHeading:
  ...
  metricText:
    "font-syne font-extrabold text-5xl md:text-6xl text-white tracking-[-0.05em] leading-none mb-1.5 transition-transform duration-300 group-hover:scale-105 origin-left relative z-10 pointer-events-none",
  metricLabelText:
