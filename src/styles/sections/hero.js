export const heroStyles = {
  ...
  btnGroup:
    "flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto mb-8 sm:mb-10 lg:mb-16",
  primaryBtn:
  ...
  statsCard:
    "bg-white/[0.04] p-4 sm:p-5 lg:p-5.5 text-center flex flex-col justify-center",
  statsValue:
    "font-syne font-extrabold text-[24px] sm:text-3xl lg:text-4xl text-white tracking-tighter leading-none mb-1.5",
  statsLabel:
    "text-[10px] sm:text-[11px] lg:text-[12px] font-medium font-inter text-white/50 mb-1",
  statsNote:
    "text-[9px] lg:text-[10px] font-semibold font-inter text-[#06B6D4] tracking-wider",
  scrollIndicator:
    "absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5",
