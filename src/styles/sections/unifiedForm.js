export const unifiedFormStyles = {
  ...
  challengesContainer: "w-full flex flex-col gap-3 mt-1 text-left",
  challengeRow:
    "flex items-start gap-3 p-3 rounded-lg bg-white/[0.02] border border-white/5 hover:border-white/10 transition-all cursor-pointer select-none group/row",
  challengeRowActive:
  ...
  legalNotice:
    "text-[10px] font-inter text-[#677489] max-w-[280px] text-center sm:text-right leading-normal tracking-wide",
  legalLink:
    "text-[#A3B1CC] hover:text-[#FF7A59] underline transition-colors mx-0.5",
  successCard:
