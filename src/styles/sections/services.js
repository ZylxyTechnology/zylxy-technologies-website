export const servicesStyles = {
  detailPageWrapper:
    "min-h-screen bg-[#F8FAFC] py-24 px-4 sm:px-6 lg:px-8 overflow-x-hidden",
  headerRow: "flex flex-col gap-6 mb-12 w-full",
  pillLine: "flex items-center gap-3 mb-4",
  pillLineBar: "w-8 h-1 bg-[#2563EB] rounded-full",
  pillText:
    "text-[12px] font-bold font-inter text-[#2563EB] tracking-[0.15em] uppercase",
  mainHeading:
    "font-syne font-extrabold text-4xl sm:text-5xl text-[#0F172A] mb-4 tracking-tight leading-tight",
  subHeading: "text-base text-slate-500 font-inter leading-relaxed max-w-lg",
  ...
  tabBtnMobile:
    "w-full min-w-0 px-3 py-2.5 rounded-lg text-[12px] font-semibold font-inter cursor-pointer border-none transition-all duration-300 flex items-center justify-center gap-2 whitespace-normal text-center leading-tight outline-none",
  tabBtnDesktop:
    "px-4 py-2.5 rounded-lg text-[13.5px] font-semibold font-inter cursor-pointer border-none transition-all duration-300 flex items-center gap-2 whitespace-nowrap outline-none shrink-0 justify-center",

  tabBtnActive: "bg-[#2563EB] text-white shadow-md shadow-blue-500/20",
  tabBtnInactive:
    "bg-transparent text-slate-500 hover:bg-slate-50 hover:text-[#2563EB]",

  tabCounter:
    "text-[10px] font-bold px-2 py-0.5 rounded-md transition-all duration-300 shrink-0",
  ...
  card: "group relative flex flex-col bg-white rounded-xl p-5 border border-slate-200 shadow-sm transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_30px_-10px_rgba(37,99,235,0.12)] hover:border-[#BFDBFE] no-underline overflow-hidden h-full w-full",
  cardHoverBg:
  ...
  cardTitle:
    "font-syne font-bold text-base text-slate-900 mb-1.5 leading-snug tracking-tight group-hover:text-[#2563EB] transition-colors duration-300",
  cardDesc: "text-[12.5px] text-slate-500 font-inter leading-relaxed mb-5",
