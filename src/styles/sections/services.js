export const servicesStyles = {
  ...
  tabContainer:
    "flex p-[5px] gap-[4px] shrink-0 bg-white border border-[#E2E8F0] rounded-[10px] shadow-[0_1px_6px_rgba(15,23,42,0.05)] overflow-x-auto max-w-full [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  tabBtn:
    "px-[14px] sm:px-[18px] py-[8px] rounded-[7px] text-[13px] font-semibold font-inter cursor-pointer border-none transition-all duration-200 flex items-center gap-[7px] whitespace-nowrap outline-none",
  tabBtnActive:
  ...
  detailMetaBox: "absolute top-[-22] left-0 p-8 lg:p-12 w-full mt-4",
  detailMetaBadge:
