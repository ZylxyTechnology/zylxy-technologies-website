export const leadFormStyles = {
  ...
  radialGlow:
    "absolute w-[min(600px,90vw)] h-[min(600px,90vw)] rounded-full bg-[#2563EB]/10 blur-3xl -bottom-48 -right-48 pointer-events-none",
  ...
  mainHeading:
    "font-lexend font-extrabold text-[clamp(1.75rem,5vw,2.75rem)] text-white tracking-tight leading-[1.2] py-1 relative z-20",
  subHeading:
