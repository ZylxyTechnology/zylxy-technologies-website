export const footerStyles = {
  ...
  logoText:
    "font-syne font-extrabold text-[clamp(40px,6vw,72px)] text-white/60 tracking-[-0.05em] leading-none select-none",
  legalText: "text-[12px] font-inter text-white/60 mt-2 tracking-[0.04em]",
  descText:
  ...
  colTitle:
    "text-[10px] font-inter font-bold text-white/60 tracking-[0.12em] uppercase mb-5",
  linkItem:
  ...
  copyright: "text-[11.5px] font-inter text-white/60",
